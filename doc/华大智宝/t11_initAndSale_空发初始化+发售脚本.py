...
#-------------------------------------------------
#消费初始化:80 50 03 02 0B 密钥索引号1 交易金额4 终端机编号6
#-------------------------------------------------
r = scf_send_str('80 50 03 02 0B 01' + JYJE + TPOS_NO)
if CONTACTTAG=='00':
    r = scf_send_str('00c00000'+r[-2:])
#卡片响应：余额4 脱机交易序号2 透支限额3 密钥版本号1（DPK）算法标识1（DPK）伪随机数4
#伪随机数
Random = r[22:30]
print 'Random = ' + Random
#钱包余额
...
# 需要计算CRC 
CRC_VALUE = '1122' 
r = scf_send_str('80DC 02B8 30 02 2E 00 00 18 00 00 00 00 00 00 00 00 00 00 00 02 01' + DEVICETYPE_CODE +JYTIME +'00000000000000000000000000000000000000' + CRC_VALUE)
scf_assert_str(r[-4:],'9000','failed!')
