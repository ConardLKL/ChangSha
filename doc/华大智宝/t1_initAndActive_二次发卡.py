...
r = scf_send_str('0084000004')
MACinit = r[:8]+'00000000'
macData = '04DC02BC 34 02 2E 00 00 09 00 00 0000 00000000000000 00 00 9000 00000000000000 00 000000000000000000000000000000000000 4F95'
macResult = scf_tdesmac(FileManage2,macData,MACinit)
macResult = macResult[:8]
r = scf_send_str('04DC02BC 34 022E 00 00 09 00 00 00 00 00 00 00 00 00 00 00 00 00 90 0000000000000000000000000000000000000000000000000000004F95' + macResult)
scf_assert_str(r[-4:],'9000','failed!')
